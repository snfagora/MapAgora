...
As Tocqueville stressed in *Democracy in America* (1835), voluntarism is a defining characteristic of American democracy. From this perspective, nonprofit organizations are vital to understanding civic activities and their economic, political, and social consequences in the U.S. Journals like *The Journal of Voluntary and Nonprofit Organizations* and *The Foundation Review* are entirely devoted to this subject. Many political science, economics, public administration, sociology, and social welfare journals publish on this issue. Despite this long-standing interest, it is difficult to analyze these organizations systematically at *scale* because information about them is scattered across various sources, such as their tax reports, websites, and social media posts. In addition, the data in these sources is stored in diverse, unstructured formats (e.g., XML, HTML, JSON) and created and organized in complex and largely inconsistent ways. Because of this, most previous research relies on limited data sources. For example, Gale's [*Encyclopedia of Associations*](https://www.gale.com/databases/gale-directory-library) has been a popular data resource among social scientists studying U.S. nonprofit organizations. Nevertheless, this gated data repository heavily relies on tax reports.
